...
* **Execution Time:** ~23,000 µs (23 ms)
...
* **The Result:** The math was isolated entirely within the CPU's Arithmetic Logic Unit (ALU). Execution time dropped to **~16,000 µs (16 ms)**, yielding a ~30% speedup without changing the algorithm's Big-O complexity.
...
* **The Result:** Execution time plummeted to **~9,400 µs (9.4 ms)**. 
